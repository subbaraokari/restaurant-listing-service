  ...
  stages {
    ...
    stage('Maven Build'){
     ...
     stage('Run Tests') {
      ...
      steps {
          ...
          sh 'docker build -t ksraotech/restaurant-listing-service1:${VERSION} .'
          sh 'docker push ksraotech/restaurant-listing-service1:${VERSION}'
      }
    } 
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: ksraotech\\/restaurant-listing-service1:${VERSION}/" aws/restaurant-manifest.yml
        '''
